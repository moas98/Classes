...
namespace Training_Courses.Migrations
{
    ...
    [Migration("20210905110258_FixInstallmentStructure_1")]
    partial class FixInstallmentStructure_1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InstallmentsStudents", b =>
                {
                    ...
                    b.HasKey("InstallmentsId", "StudentId");

                    b.HasIndex("StudentId");

                    b.ToTable("InstallmentsStudents");
                });
            ...
            modelBuilder.Entity("InstallmentsStudents", b =>
                {
                    b.HasOne("Training_Courses.Models.Entities.Installments", null)
                        .WithMany()
                        .HasForeignKey("InstallmentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Training_Courses.Models.Entities.Students", null)
                        .WithMany()
